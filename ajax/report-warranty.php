    ...
    <div id="miscCriteria" class="tab-pane fade">
        <div class="smart-form">            
            <fieldset>
                ...
                <section class="col col-6">
                    <label class="label labelName" data="order_title">Start Time</label>
                    
                        <section class="col col-6">
                            <label class="input">Start Date</label>
                            <input type="date" name="startTimeStartDate" id="startTimeStartDate" value="" class="form-control" >
                            <p></p>
                        </section>
                        <section class="col col-6">
                            <label class="input">End Date</label>
                            <input type="date" name="startTimeEndDate" id="startTimeEndDate" value="" class="form-control" >
                            <p></p>
                        </section>                    
                </section>
                <section class="col col-6">
                    <label class="label labelName" data="order_title">End Time</label>
                    
                        <section class="col col-6">
                            <label class="input">Start Date</label>
                            <input type="date" name="endTimeStartDate" id="endTimeStartDate" value="" class="form-control" >
                            <p></p>
                        </section>
                        <section class="col col-6">
                            <label class="input">End Date</label>
                            <input type="date" name="endTimeEndDate" id="endTimeEndDate" value="" class="form-control" >
                            <p></p>
                        </section>                    
                </section>
                <section class="col col-6">
                    <label class="label labelName" data="order_title">Closing Time</label>
                    
                        <section class="col col-6">
                            <label class="input">Start Date</label>
                            <input type="date" name="closingTimeStartDate" id="closingTimeStartDate" value="" class="form-control" >
                            <p></p>
                        </section>
                        <section class="col col-6">
                            <label class="input">End Date</label>
                            <input type="date" name="closingTimeEndDate" id="closingTimeEndDate" value="" class="form-control" >
                            <p></p>
                        </section>                    
                </section>
...
<div class="modal fade" id="modalSearch" role="dialog">
    <div class="report-modal-dialog modal-dialog modal-lg" >
...
<script src="./js/script/report/report-warranty.js"></script>