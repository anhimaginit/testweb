        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    <h1 class="error-text-2 bounceInDown animated"> Error <span id="error_code"><?php echo (isset($_GET['code']) ? $_GET['code'] : '') ?></span><span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
                    <h2 class="font-xl"><strong><span id="error_text_forward"><?php echo (isset($_GET['text']) ? $_GET['text'] : '') ?></span></strong></h2>
                    <br />
                    <div class="lead" id="error-content">
                    </div>
                    <button type="button" class="btn btn-default btnGoBack">Go Back</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- end row -->
<script>
    if (window.error_code_forward) {
        document.getElementById('error_code').innerHTML = window.error_code_forward;
        delete window.error_code_forward;
    }

    if (window.error_text_forward && !window.error_text_forward.includes('[object HTMLSpanElement]')) {
        document.getElementById('error_text_forward').innerHTML = window.error_text_forward;
        delete window.error_text_forward;
    }

    if (window.error_content) {
        document.getElementById('error-content').innerHTML = window.error_content;
        delete window.error_content;
    }
</script>
