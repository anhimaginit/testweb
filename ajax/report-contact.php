        ...
        <fieldset> 
            <div>
                ...
                <section class="col col-xs-6 text-right">
                    ...
                    <button class="btn btn-default" style="padding:5px" id="btnDownloadCsvReportContact"><i class="fa fa-download"></i> CSV Download</button>
                    <button class="btn btn-primary" style="padding:5px" id="btnSearchReportContact" data-toggle="modal" data-target="#modalSearch"><i class="fa fa-search"></i> Search</button>
                </section>
            </div>
        </fieldset>
...
<script src="./js/script/report/report-contact.js"></script>
